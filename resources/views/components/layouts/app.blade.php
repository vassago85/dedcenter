                ...
                @auth
                    @if($currentOrg)
                        ...
                        <a href="{{ route('org.dashboard', $currentOrg) }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('org.dashboard') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                        ...
                        <a href="{{ route('org.matches.index', $currentOrg) }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('org.matches.*') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                        ...
                        <a href="{{ route('org.registrations', $currentOrg) }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('org.registrations') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                        ...
                        <a href="{{ route('org.admins', $currentOrg) }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('org.admins') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                        ...
                        <a href="{{ route('org.settings', $currentOrg) }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('org.settings') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                    ...
                    @else
                        ...
                        <a href="{{ route('dashboard') }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('dashboard') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                            <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25a2.25 2.25 0 0 1-2.25-2.25v-2.25Z" /></svg>
                            Dashboard
                        </a>

                        <a href="{{ route('browse-events') }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('browse-events') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                        ...
                        <a href="{{ route('notifications') }}"
                           class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('notifications') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                        ...
                        @else
                            ...
                            <a href="{{ route('organizations.create') }}"
                               class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors text-secondary hover:bg-surface-2/50 hover:text-primary focus:outline-none focus:ring-2 focus:ring-accent">
                                <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
                        ...
                        @if($authUser->isOwner())
                            ...
                            <div x-show="adminOpen" x-collapse x-cloak class="space-y-1">
                                ...
                                <a href="{{ route('admin.organizations') }}"
                                   class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('admin.organizations') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                                    <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z" /></svg>
                                    Organizations
                                ...
                                <a href="{{ route('admin.members') }}"
                                   class="flex items-center gap-3 rounded-lg px-3 min-h-[44px] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-accent {{ request()->routeIs('admin.members') ? 'bg-surface-2 text-primary' : 'text-secondary hover:bg-surface-2/50 hover:text-primary' }}">
                                    <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" /></svg>
                                    Members
                                </a>
            ...
            <div class="border-t border-border px-4 py-3 space-y-2">
                ...
                <div class="flex items-center gap-2 px-2">
                    ...
                    <div class="min-w-0 flex-1">
                        <span class="text-xs text-secondary truncate block">{{ $authUser->name }}</span>
                    </div>
                </div>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex w-full items-center gap-2 rounded-lg px-3 min-h-[44px] text-sm text-muted transition-colors hover:bg-surface-2 hover:text-primary focus:outline-none focus:ring-2 focus:ring-accent">
                ...
                @auth
                    @if($authUser->canScore())
                        <a href="https://{{ config('domains.app') }}/score" target="_blank"
                           class="inline-flex items-center gap-2 rounded-lg px-3 min-h-[44px] text-sm font-medium text-white transition-colors focus:outline-none focus:ring-2 focus:ring-accent" style="background:#ff2b2b;">
                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
