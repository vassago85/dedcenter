                                ...
                                @foreach($matches as $match)
                                    @php
                                        ...
                                        $cellTitle = $cartridge
                                            ...
                                            : $match->name;
                                    @endphp
                                    <td class="px-3 py-3 text-right text-xs whitespace-nowrap {{ $result === null ? 'text-slate-700' : ($counted ? 'text-primary font-medium' : 'text-muted line-through decoration-muted/50') }}" title="{{ $cellTitle }}">
