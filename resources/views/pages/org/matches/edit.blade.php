                                    ...
                                    <tbody class="divide-y divide-border/50">
                                        @foreach($squad->shooters->sortBy('sort_order') as $shooter)
                                            <tr wire:key="shooter-{{ $shooter->id }}">
                                                ...
                                                @endif
                                                <td class="px-3 py-2 text-right"><flux:button size="sm" variant="ghost" class="!text-accent hover:!text-accent" wire:click="deleteShooter({{ $shooter->id }})">&times;</flux:button></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
