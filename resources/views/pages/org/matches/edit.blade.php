            ...
            <div class="rounded-xl border border-dashed border-border bg-surface/50 p-4 space-y-3">
                ...
                <div class="flex gap-3 items-end flex-wrap">
                    <div class="w-32">
                        ...
                        {{-- Bound straight to the Livewire property (not Alpine-local
                             state) so the value is always in sync when the button is
                             clicked — the old Alpine `dist` could arrive empty on a
                             re-render and the click would silently do nothing. --}}
