    ...
    <div class="mx-auto max-w-6xl px-6 py-20 lg:py-28">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">No signal at the range? No problem. Scores are saved locally on the device and sync automatically when connectivity returns.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">TV scoreboard for the range, plus a mobile-friendly live page spectators can open by scanning a QR code. Auto-refreshes every 10 seconds.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">Hit / Miss / Shot Not Taken buttons for each target. Timed stages with smart decimal input, tiebreaker stage support, and par time auto-fill.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">Split shooters by equipment class (Open, Factory, Limited) and demographics (Overall, Ladies, Junior, Senior). Filter scoreboards by either axis.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">Create a league, add clubs underneath it. Season leaderboards aggregate scores across matches with best-of-N scoring.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">Only the person who created a match can edit or delete it. Multiple admins per club, but each match director owns their match.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">A QR code is generated for every active match. Print it or show it on screen &mdash; spectators scan it and get the live scoreboard on their phone.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">Multiple Range Officers can score simultaneously on different tablets. All scores merge on the server and appear on the scoreboard in real-time.</p>
            </div>

            <div class="rounded-2xl border border-border bg-surface p-8">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-muted/10">
                    <svg class="h-6 w-6 text-muted" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <p class="text-sm text-muted leading-relaxed">Shooters register for matches online. Set entry fees, approve/reject registrations, and track payments. Free matches are supported too.</p>
            </div>

            <div class="rounded-2xl border border-amber-800/30 bg-surface p-8 ring-1 ring-amber-600/10">
                <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-amber-600/10">
                    <svg class="h-6 w-6 text-amber-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <p class="text-sm text-muted leading-relaxed">Optional side competition for round-robin matches. The winner is whoever hits the most smallest gongs. Ties break by furthest distance, then cascade to the next gong size.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <p class="text-sm text-muted leading-relaxed">Only authorized users can submit scores. The Match Director logs into each tablet and locks it to a specific squad to prevent accidental edits on other squads.</p>
            </div>
            ...
            <div class="rounded-2xl border border-border bg-surface p-8">
                ...
                <h3 class="mb-2 text-lg font-semibold">Standard Gong Scoring</h3>
                <p class="text-sm text-muted leading-relaxed">Point multipliers based on gong size and difficulty. Round-robin relay flow with auto-advancing scorer. Quick-add preset targets included.</p>
            </div>
