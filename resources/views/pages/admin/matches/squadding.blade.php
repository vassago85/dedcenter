...
new #[Layout('components.layouts.app')]
    ...
    public function randomizeRelays(): void
    {
        ...
        $shootersInDefault = $defaultSquad
...
<div class="space-y-6 max-w-6xl">
    ...
    <div class="flex flex-wrap items-center gap-2 text-xs text-muted">
        ...
        @php $relayIndex = 0; $colors = ['bg-blue-500/20 text-blue-400', 'bg-emerald-500/20 text-emerald-400', 'bg-amber-500/20 text-amber-400', 'bg-purple-500/20 text-purple-400', 'bg-pink-500/20 text-pink-400']; @endphp
