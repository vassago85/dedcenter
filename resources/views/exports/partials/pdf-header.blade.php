                    ...
                    <table class="rf-mark"><tr>
                        <td class="rf-suits">
                            <svg width="46" height="20" viewBox="0 0 46 20" xmlns="http://www.w3.org/2000/svg">
                                {{-- Spade --}}
                                <path d="M6 2 C6 2 11 6 11 10 C11 12 9 13 8 13 C7.4 13 7 12.7 6.7 12.3 L7.5 16 L4.5 16 L5.3 12.3 C5 12.7 4.6 13 4 13 C3 13 1 12 1 10 C1 6 6 2 6 2 Z" fill="#0f172a"/>
                                {{-- Heart --}}
