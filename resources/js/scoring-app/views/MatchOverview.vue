                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-3 pt-2">
                        ...
                        <template v-if="matchStore.currentMatch.status === 'completed'">
                            ...
                            <router-link
                                v-if="matchStore.currentMatch.scoring_type === 'elr'"
                                :to="{ name: 'elr-rankings', params: { matchId: props.matchId } }"
                        ...
                        <router-link
                            v-if="matchStore.currentMatch.status !== 'completed' && matchStore.currentMatch.scoring_type === 'elr'"
                            :to="{ name: 'elr-rankings', params: { matchId: props.matchId } }"
                            class="flex items-center justify-center gap-2 rounded-xl border border-slate-600 bg-slate-800 py-3 font-semibold text-white transition-colors hover:bg-slate-700"
                        >
                            View Rankings
